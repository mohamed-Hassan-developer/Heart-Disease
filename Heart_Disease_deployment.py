...
html_title = """<h1 style="color:white;text-align:center;"> <span style="color:red">Heart Disease </span> Risk Exploratory Data Analysis </h1>"""
st.markdown(html_title, unsafe_allow_html=True)
    # Set Title 
st.set_page_config(layout='wide', page_title= 'Heart Disease Risk EDA',page_icon='💔')
